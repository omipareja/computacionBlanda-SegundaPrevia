...
axo.plot(x_calidad, calidad_baja, 'b', linewidth=1.5, label='Mala') 
axo.plot(x_calidad, calidad_media, 'g', linewidth=1.5, label='Aceptable')
axo.plot(x_calidad, calidad_alta, 'r', linewidth=1.5, label='Buena') 
axo.set_title('Calidad de la comida')
axo.legend() 
...
axo.fill_between(x_propina, propina0, activacion_propina_baja, facecolor='b', alpha=0.7)
axo.plot(x_propina, propina_baja, 'b', linewidth=0.5, linestyle='--', ) 
axo.fill_between(x_propina, propina0, activacion_propina_media, facecolor='g', alpha=0.7)
axo.plot(x_propina, propina_media, 'g', linewidth=0.5, linestyle='--') 
axo.fill_between(x_propina, propina0, activacion_propina_alta, facecolor='r', alpha=0.7)
axo.plot(x_propina, propina_alta, 'r', linewidth=0.5, linestyle='--')
...
axo.plot(x_propina, propina_media, 'g', linewidth=0.5, linestyle='--')
axo.plot(x_propina, propina_alta, 'r', linewidth=0.5, linestyle='--') 
axo.fill_between(x_propina, propina0, agregado, facecolor='Orange', alpha=0.7)
axo.plot([propina, propina], [0, activacion_propina], 'k', linewidth=1.5, alpha=0.9)
